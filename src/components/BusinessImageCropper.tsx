      ...
      <CardContent className="space-y-6 px-0">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1">
            <div
              className="crop-container relative w-full aspect-square max-w-[400px] mx-auto border-2 border-orange-200 overflow-hidden bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl shadow-lg"
            ...
            >
              ...
              {isDraggingImage && (
                <div className="absolute top-3 right-3 bg-white border border-orange-300 text-orange-700 text-sm px-3 py-1.5 rounded-lg shadow-lg backdrop-blur-sm">
              ...
              {imageLoaded && (
                <div
                  className="absolute border-4 border-orange-500 rounded-full bg-orange-500/10 cursor-move hover:bg-orange-500/20 transition-all shadow-xl backdrop-blur-sm"
                  style={{
                    left: cropArea.x,
                    top: cropArea.y,
                ...
                >
                  ...
                  <div className="absolute top-3 left-3 bg-white border-2 border-orange-400 text-orange-700 text-xs px-2 py-1 rounded-full shadow-md">
            ...
            <div className="mt-4 bg-orange-50 border border-orange-200 rounded-lg p-3 text-sm text-orange-800">
              <span className="font-semibold">💡 Tip:</span> Arrastra la imagen para posicionarla. Mueve el círculo naranja para ajustar el área de recorte.
            </div>
          </div>
          ...
          <div className="w-full lg:w-80 space-y-4">
            {/* Tamaño del crop */}
            <div className="space-y-2 bg-white p-4 rounded-xl border border-orange-100 shadow-sm">
            ...
            <div className="space-y-2 bg-gradient-to-br from-orange-50 to-amber-50 p-4 rounded-xl border border-orange-200">
              <Label className="text-sm font-semibold text-gray-700 flex items-center gap-2">
        ...
        {/* Botones de acción */}
        <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-6 border-t border-orange-100">
          <Button
            variant="outline"
            onClick={onCancel}
