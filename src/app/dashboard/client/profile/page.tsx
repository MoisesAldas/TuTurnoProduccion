...
export default function ClientProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/50">
      ...
      <div className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm border-b border-gray-100 dark:border-gray-800 sticky top-0 z-30 shadow-sm md:h-20 flex items-center">
              ...
              <div>
                ...
                <h1 className="text-xl sm:text-2xl font-black tracking-tight text-gray-900 dark:text-gray-50 flex items-center justify-center md:justify-start gap-3">
                  ...
                  <div className="flex items-center justify-center w-8 h-8 rounded-xl bg-slate-100 dark:bg-slate-800 border border-slate-200/50 dark:border-slate-700/50 shadow-sm">
                    <Settings className="w-4 h-4 text-slate-900 dark:text-slate-100" />
                  </div>
                </h1>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center w-full md:w-auto gap-3">
              {!isEditing ? (
                <Button 
                  ...
                  className="w-full md:w-auto bg-slate-900 hover:bg-slate-800 shadow-xl hover:shadow-slate-900/20 transition-all duration-300 text-white font-black h-10 px-8 rounded-2xl text-xs tracking-tight"
                >
                ...
                <div className="flex items-center justify-center w-full md:w-auto gap-3">
                  <Button 
                    ...
                    disabled={saving}
                    className="flex-1 md:flex-none h-10 border-slate-200 text-slate-600 font-black px-6 rounded-2xl hover:bg-slate-50 transition-all text-xs tracking-tight"
                  >
                    CANCELAR
                  </Button>
                  <Button 
                    onClick={handleSave} 
                    disabled={saving}
                    className="flex-[2] md:flex-none bg-slate-900 hover:bg-slate-800 shadow-xl hover:shadow-slate-900/20 text-white font-black h-10 px-8 rounded-2xl transition-all text-xs tracking-tight"
                  >
