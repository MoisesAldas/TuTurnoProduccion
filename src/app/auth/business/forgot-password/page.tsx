            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3 pt-4 border-t border-gray-100 dark:border-gray-700">
                ...
                <Link href="/auth/business">
                  <Button variant="outline" className="w-full border-2 border-orange-200 dark:border-orange-700 text-orange-700 dark:text-orange-400 hover:bg-orange-50 dark:hover:bg-orange-900/20">
                    Inicio
                  </Button>
                </Link>
              </div>
