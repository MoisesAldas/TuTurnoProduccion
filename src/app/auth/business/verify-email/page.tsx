      ...
      <div className="hidden lg:flex lg:w-1/2 bg-orange-600 hover:bg-orange-700 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <p className="text-xl text-white/80 max-w-md">
            Estás a un paso de comenzar a gestionar tu negocio con TuTurno
          </p>
        </div>
        ...
        <div className="w-full max-w-md space-y-3 py-2">
          ...
          <Card className="border-gray-200 shadow-sm">
            <CardHeader className="text-center pb-3">
              <div className="w-12 h-12 bg-orange-600 rounded-2xl flex items-center justify-center mx-auto mb-3 shadow-lg">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="bg-orange-50 rounded-lg p-3 border border-orange-200">
                <p className="text-orange-800 font-medium text-sm text-center break-all">
                  {email}
                </p>
              </div>
