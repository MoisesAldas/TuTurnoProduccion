        ...
        <Card className="w-full max-w-md bg-white/95 dark:bg-gray-800/95 border-white/40 dark:border-gray-700/40">
          <CardContent className="p-6 text-center">
            ...
            <Link href="/auth/business">
              <Button variant="outline" className="border-2 border-orange-200 dark:border-orange-700 text-orange-700 dark:text-orange-400 hover:bg-orange-50 dark:hover:bg-orange-900/20">Volver al inicio</Button>
            </Link>
          </CardContent>
        </Card>
      </div>
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center p-4 relative overflow-hidden transition-all duration-1000 ${
      ...
      <div className="w-full max-w-md space-y-6 relative z-10">
        ...
        {/* Success Alert */}
        {resent && (
          <Alert className={`border-orange-200 dark:border-orange-800 bg-orange-50/90 dark:bg-orange-900/20 backdrop-blur-sm transition-all duration-500 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
          }`} style={{ transitionDelay: '400ms' }}>
        ...
        <Card className={`bg-white/95 dark:bg-gray-800/95 backdrop-blur-md border border-white/40 dark:border-gray-700/40 shadow-xl hover:shadow-2xl transition-all duration-500 ${
          ...
          <CardContent className="space-y-6">
            ...
            <div className="bg-orange-50 dark:bg-orange-900/20 rounded-lg p-4 border border-orange-200 dark:border-orange-800">
              <p className="text-orange-800 dark:text-orange-300 font-medium text-center break-all">
                {email}
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <Clock className="w-5 h-5 text-orange-600 dark:text-orange-500 mt-0.5 flex-shrink-0" />
                <div>
            ...
            <div className="pt-4 border-t border-gray-100 dark:border-gray-700 text-center">
              ...
              <Button
                ...
                disabled={resending}
                variant="outline"
                className="border-2 border-orange-200 dark:border-orange-700 text-orange-700 dark:text-orange-400 hover:bg-orange-50 dark:hover:bg-orange-900/20 transition-all duration-200"
              >
                {resending ? (
                  <>
                    <div className="animate-spin w-4 h-4 border-2 border-orange-600 dark:border-orange-500 border-t-transparent rounded-full mr-2"></div>
                    Reenviando...
                  </>
                ) : (
                  <>
