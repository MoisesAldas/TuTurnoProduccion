...
export interface Appointment {
  ...
  notes?: string;
  client_notes?: string;
  client_name?: string; // Para clientes walk-in
  client_phone?: string; // Para clientes walk-in
  walk_in_client_name?: string; // Deprecated: usar client_name
  walk_in_client_phone?: string; // Deprecated: usar client_phone
  created_at: string;
  updated_at: string;
